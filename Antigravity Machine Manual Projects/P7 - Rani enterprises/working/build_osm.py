...
Writes under Antigravity Machine Manual Projects. Navy/Calibri format.
Full 25-30+ page depth matching Indo-MIM V5 / Grok P7 standard.
"""
...
def build_header_footer(doc: Document):
    ...
    fr = fp.add_run("CONFIDENTIAL — Antigravity Sample  |  Rani Enterprises")
...
def cover(doc):
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    r = p.add_run("CONFIDENTIAL — Antigravity Sample / Draft")
